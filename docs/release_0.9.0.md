...
* Release 0.8.2 by @oeble in <https://github.com/hubbleprotocol/scope/pull/190>
* Update xSTEP oracle mapping and add TWAP support by @oeble in <https://github.com/hubbleprotocol/scope/pull/193>
* Add Jupiter lp recomputed price type by @oeble in <https://github.com/hubbleprotocol/scope/pull/192>

**Full Changelog**: <https://github.com/hubbleprotocol/scope/compare/release/v0.8.2...release/v0.9.0>
...
5. [x] `make build` and check that it actually builds
6. [x] Dump old program in case of rollback: `solana program dump -u $URL HFn8GnPADiny6XqUoWE8uRPPxb29ikn4yTuPa9MF2fWJ scope-0.8.2.so`
